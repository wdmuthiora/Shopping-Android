...
import com.moringaschool.shopping.Activity.Adapter.CategoryAdapter;
import com.moringaschool.shopping.Activity.Adapter.PopularAdapter;
import com.moringaschool.shopping.Activity.Domain.CategoryDomain;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewPopular(); //call the recyclerView on create.
        bottomNavigation();
    ...
    private void recyclerViewPopular() {
        ...
        foodList.add(new FoodDomain("Pepperoni pizza", "pizza1", "1slices pepperoni ,mozzarella cheese, fresh oregano,  ground black pepper, pizza sauce", 9.76));
    ...
    //to place the scrollable-horizontally section.
